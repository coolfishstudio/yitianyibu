            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 7:
                        ...
                        _context4.next = 10;
                        return _manager2.default.addCategory({ name: name, weight: weight, createdByID: createdByID });
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    ...
                    case 7:
                        _context5.next = 9;
                        return _manager2.default.updateCategoryById(req.params.categoryId, { name: name, weight: weight });
